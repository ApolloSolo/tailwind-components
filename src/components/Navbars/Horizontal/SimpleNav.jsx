  ...
  return (
    <nav className="shadow-md relative w-full bg-[#15a0af]">
      <div className="md:flex justify-between py-4 md:px-10 px-4">
        ...
        <ul className={`md:flex md:items-center md:pb-0 pb-4 md:static absolute bg-[#15a0af] md:z-auto z-[1] left-0 w-full md:w-auto md:pl-0 pl-4 transition-all duration-300 ease-in ${open ? 'top-[60px] opacity-100':'top-[-500px] opacity-0'} md:opacity-100`}>
          {
            Links.map((link) => (
